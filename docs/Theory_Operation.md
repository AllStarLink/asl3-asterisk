...
```
git clone git@github.com:AllStarLink/app_rpt.git
```

4. Execute the `build-tree` process. For example:
``` 
asl3-asterisk/build-tree -a 22.5.2 -v 3.6.1 -r 1
```
...
environment. As much as possible, and without making it
...
repository. For example - 0.0.2.fadead4. In post-release beta
